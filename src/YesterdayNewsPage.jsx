...
function formatdate({ dateofnews }) {
  ...
  function getCurrentDate() {
    ...
    today.setDate(today.getDate() -2); // Subtract 1 day from the current date
...
export default function YesterdayNewsPage({ bookmark, setBookmark, news, isLoading, setIsLoading, setNews }) {
